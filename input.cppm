...
namespace input {
  ...
  export enum class buttons { ACTION, CANCEL, REST };
...
bool input::state(buttons b) {
  switch (b) {
    ...
    case buttons::CANCEL: return g_state[CANCEL];
...
void input::on_button_down(buttons b, hai::fn<void> fn) {
  switch (b) {
    ...
    case buttons::CANCEL: g_btn_down_cb[CANCEL] = fn; break;
